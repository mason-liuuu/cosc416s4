...
public class CoinCounterUI : MonoBehaviour
{
    ...
    private float containerUnitPosition;
    ...
    private void Start(){
        ...
        current.SetText("0");
        toUpdate.SetText("0");
        containerUnitPosition = coinTextContainer.localPosition.y;
    ...
    public void UpdateScore(int score){
        ...
        coinTextContainer.DOLocalMoveY(containerUnitPosition + moveAmount,duration).SetEase(animationCurve);
    ...
    private IEnumerator ResetCoinContainer(int score){
        ...
        containerUnitPosition, localPosition.z);
    }
